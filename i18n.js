...
var I18N = (function () {
  ...
  var STRINGS = {
    ko: {
      ...
      home_beta_note: '안녕하세요? 나조식입니다. 20년~22년 사이 인스타그램에 올렸던 게시물의 포맷이 제각각이기도 하고 레시피를 제공한다는 관점에서는 부실한 것들이 많아서 넣을까 말까 아니면 수정할까 고민했습니다. 하지만 개인의 기록으로는 가치가 있을 것 같아서 가능한 한 원본 그대로 남겨두었습니다. 제목이며 내용이 전반적으로 들쭉날쭉한데 천천히 다듬어 보겠습니다. 그래서 Beta라고 했는데, Beta를 언제 뗄 수 있을지는 모르겠습니다.',
