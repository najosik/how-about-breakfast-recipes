...
var I18N = (function () {
  ...
  var STRINGS = {
    ko: {
      ...
      home_beta_note: '안녕하세요? 나조식입니다. 인스타그램(@how.about.breakfast)의 게시물을 웹에서 손쉽게 찾아볼 수 있도록 아카이빙 했습니다. 재료는 있는데 레시피가 궁금할 때, 뭘 먹을까 좋은 생각이 떠오르지 않을 때, 이도저도 아니면 그냥 남들을 뭘 먹고 사나 엿보고 싶을 때 이용해 주시면 좋겠습니다.\n\n주의! 20년~22년 게시물 가운데 일부분은 개인의 생각과 레시피 사이에서 왔다갔다, 들쭉날쭉합니다. 천천히 다듬어 보겠습니다. (사실 그래서 Beta인데, Beta를 언제 뗄 수 있을지는 모르겠습니다.)',
